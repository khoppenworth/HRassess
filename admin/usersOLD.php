      ...
      <div class="card-body">
        <form method="post">
          <div class="form-row">
            ...
            <div class="form-group col-md-3"><label><?= htmlspecialchars($t['role']) ?></label><select class="form-control" name="role"><option value="staff">Staff</option><option value="admin">Admin</option></select></div>
